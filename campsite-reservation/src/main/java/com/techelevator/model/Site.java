...
public class Site {
	...
	public String siteInfo(Campground camp, long numberOfDays) {
		
		String str = String.format("%-12s%-12s%-13s%-14s%-10s$%-8.2f", site_number, max_occupancy, 
				accessible, max_rv_length, utilities, (camp.getDaily_fee() * numberOfDays) );
